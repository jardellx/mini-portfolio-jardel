/*
    ...
    o conteudo da aba que  foi selecionada e esconder
...
function mostrarInformacoesDaAba(aba){
      ...
      const idDoEelementoDeInformacoesDaAba = `informacao-${aba.id}`

      const informacaoASerMostrada = document.getElementById(idDoEelementoDeInformacoesDaAba)
